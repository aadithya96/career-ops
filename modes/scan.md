...
- **Ashby**: `"Senior .NET Engineer (Remote) @ Acme"` → title: `Senior .NET Engineer`, company: `Acme`
- **Greenhouse**: `"Backend Engineer at Company"` → title: `Backend Engineer`, company: `Company`
- **Lever**: `"Platform Engineer - Backend @ Startup"` → title: `Platform Engineer - Backend`, company: `Startup`
