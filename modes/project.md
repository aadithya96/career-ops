...
|-----------|--------|---------|---------|
| Signal for target roles | 25% | Directly demonstrates skill from target JDs | Unrelated |
| Uniqueness | 20% | Nobody has done this | Everyone has it |
| Demo-ability | 20% | Live demo in 2 min | Code only, nothing visual |
| Metrics potential | 15% | Clear metrics (latency, throughput, reliability) | No metrics possible |
...
1. **One-pager**: what it does + architecture + metrics + evaluation plan
