...
7. Rewrite Professional Summary injecting JD keywords + exit narrative bridge ("Built production systems at scale. Now applying that backend depth to [JD domain].")
...
- JD says "REST API design" and CV says "built HTTP endpoints" → change to "REST API design and HTTP service development"
- JD says "microservices architecture" and CV says "distributed systems" → change to "microservices architecture and distributed systems design"
- JD says "stakeholder management" and CV says "collaborated with team" → change to "stakeholder management across engineering, product, and business"
